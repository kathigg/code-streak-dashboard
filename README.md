...
Generate a GitHub-profile analytics suite with a Duolingo-style coding streak dashboard, a fire graphic, contribution trends, comment and test counts, a language pie chart, and forked 3D contribution graphics.
...
- `dist/dashboard.svg`: Streak, comments, tests, language pie chart, and coding activity trend.
